...
public class DrawableMonster extends Monster implements Drawable {
    ...
    public void draw() {
      ...
      if(location().inView()) {
       ...
       stroke(0);
       line(super.location().x() + 5, super.location().y() + 5, super.location().x() + 15, super.location().y() + 15);
       noStroke();
       stroke(0);
       line(super.location().x() + 45, super.location().y() + 5, super.location().x() + 35, super.location().y() + 15);
       noStroke();
       fill(0);
       ...
       fill(0);
       ellipse(super.location().x() + 25, super.location().y() + 40, 30, 5);
       popMatrix();
      }
    }
}